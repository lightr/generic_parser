...
ALTER TABLE ONLY public.wos_summary_name_addr_map
        ADD CONSTRAINT unique_summary_name_addr_map UNIQUE (id, name_id, addr_id);
ALTER TABLE ONLY public.wos_summary_name_addr_map
        ADD CONSTRAINT fk_summary_name_addr_map_summary_names FOREIGN KEY (id,name_id) REFERENCES public.wos_summary_names(id,name_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_publisher_names_email_addr
        ADD CONSTRAINT unique_publisher_names_email_addr UNIQUE (id, publisher_id, name_id, email_id);
ALTER TABLE ONLY public.wos_publisher_names_email_addr
        ADD CONSTRAINT fk_publisher_names_addr_publisher_names FOREIGN KEY (id,publisher_id,name_id) REFERENCES public.wos_publisher_names(id,publisher_id,name_id) ON DELETE CASCADE;

ALTER TABLE ONLY public.wos_publisher_email_addr
        ADD CONSTRAINT unique_publisher_email_addr UNIQUE (id, publisher_id, email_id);
ALTER TABLE ONLY public.wos_publisher_email_addr
        ADD CONSTRAINT fk_publisher_addr_publishers FOREIGN KEY (id,publisher_id) REFERENCES public.wos_publisher(id,publisher_id) ON DELETE CASCADE;

ALTER TABLE ONLY public.wos_publisher_zip
        ADD CONSTRAINT unique_publisher_zip UNIQUE (id, publisher_id, zip_id);
ALTER TABLE ONLY public.wos_publisher_zip
        ADD CONSTRAINT fk_publisher_zip_publisher FOREIGN KEY (id,publisher_id) REFERENCES public.wos_publisher(id,publisher_id) ON DELETE CASCADE;

ALTER TABLE ONLY public.wos_publisher_organizations
        ADD CONSTRAINT unique_publisher_organizations UNIQUE (id, publisher_id, org_id);
ALTER TABLE ONLY public.wos_publisher_organizations
        ADD CONSTRAINT fk_publisher_organizations_publisher FOREIGN KEY (id,publisher_id) REFERENCES public.wos_publisher(id,publisher_id) ON DELETE CASCADE;

ALTER TABLE ONLY public.wos_publisher_suborganizations
        ADD CONSTRAINT unique_publisher_suborganizations UNIQUE (id, publisher_id, suborg_id);
ALTER TABLE ONLY public.wos_publisher_suborganizations
        ADD CONSTRAINT fk_publisher_suborganizations_publisher FOREIGN KEY (id,publisher_id) REFERENCES public.wos_publisher(id,publisher_id) ON DELETE CASCADE;

ALTER TABLE ONLY public.wos_publisher_dois
        ADD CONSTRAINT unique_publisher_dois UNIQUE (id, publisher_id, doi_id);
ALTER TABLE ONLY public.wos_publisher_dois
        ADD CONSTRAINT fk_publisher_doi_publisher FOREIGN KEY (id,publisher_id) REFERENCES public.wos_publisher(id,publisher_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_address_email_addr
        ADD CONSTRAINT unique_address_email_addr UNIQUE (id, addr_id, email_id);
ALTER TABLE ONLY public.wos_address_email_addr
        ADD CONSTRAINT fk_address_email_addr_addresses FOREIGN KEY (id,addr_id) REFERENCES public.wos_addresses(id,addr_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_address_dois
        ADD CONSTRAINT unique_address_dois UNIQUE (id, addr_id, doi_id);
ALTER TABLE ONLY public.wos_address_dois
        ADD CONSTRAINT fk_address_doi_address FOREIGN KEY (id,addr_id) REFERENCES public.wos_addresses(id,addr_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_grant_alt_agencies
        ADD CONSTRAINT unique_grant_alt_agencies UNIQUE(id, grant_id, alt_agency_id);
ALTER TABLE ONLY public.wos_grant_alt_agencies
        ADD CONSTRAINT fk_grant_alt_agencies_grants FOREIGN KEY (id, grant_id) REFERENCES public.wos_grants(id, grant_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_reprint_address_email_addr
        ADD CONSTRAINT unique_reprint_address_email_addr UNIQUE (id, addr_id, email_id);
ALTER TABLE ONLY public.wos_reprint_address_email_addr
        ADD CONSTRAINT fk_reprint_address_email_addr_reprint_addresses FOREIGN KEY (id,addr_id) REFERENCES public.wos_reprint_addresses(id,addr_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_reprint_address_dois
        ADD CONSTRAINT unique_reprint_address_dois UNIQUE (id, addr_id, doi_id);
ALTER TABLE ONLY public.wos_reprint_address_dois
        ADD CONSTRAINT fk_reprint_address_doi_reprint_address FOREIGN KEY (id,addr_id) REFERENCES public.wos_reprint_addresses(id,addr_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_chapters
        ADD CONSTRAINT unique_chapters UNIQUE (id, chapter_id);
ALTER TABLE ONLY public.wos_chapters
        ADD CONSTRAINT fk_chapters_summary FOREIGN KEY (id) REFERENCES public.wos_summary(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wos_contributor_email_addr
        ADD CONSTRAINT unique_contributor_email_addr UNIQUE (id, contrib_id, email_id);
ALTER TABLE ONLY public.wos_contributor_email_addr
        ADD CONSTRAINT fk_contributor_addr_contributors FOREIGN KEY (id,contrib_id) REFERENCES public.wos_contributors(id,contrib_id) ON DELETE CASCADE;
