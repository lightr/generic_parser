...
DROP TABLE IF EXISTS public.wos_contributor_email_addr;
DROP TABLE IF EXISTS public.wos_contributors;
DROP TABLE IF EXISTS public.wos_chapters;
...
DROP TABLE IF EXISTS public.wos_grant_alt_agencies;
...
DROP TABLE IF EXISTS public.wos_publisher_email_addr;
DROP TABLE IF EXISTS public.wos_publisher_names_email_addr;
DROP TABLE IF EXISTS public.wos_publisher_names;
DROP TABLE IF EXISTS public.wos_publisher_zip;
DROP TABLE IF EXISTS public.wos_publisher_organizations;
DROP TABLE IF EXISTS public.wos_publisher_suborganizations;
DROP TABLE IF EXISTS public.wos_publisher_dois;
...
CREATE TABLE public.wos_publisher_names_email_addr (
        id character varying NOT NULL,
	publisher_id integer NOT NULL,
        name_id integer NOT NULL,
        email_id integer NOT NULL,
...
COMMENT ON TABLE public.wos_publisher_names_email_addr IS 'Email Address Data from Publisher Names';
COMMENT ON COLUMN public.wos_publisher_names_email_addr.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_publisher_names_email_addr.publisher_id IS 'Sequence number of associated publisher';
COMMENT ON COLUMN public.wos_publisher_names_email_addr.name_id IS 'Sequence number of associated name in list';
COMMENT ON COLUMN public.wos_publisher_names_email_addr.email_id IS 'Email address ID';
COMMENT ON COLUMN public.wos_publisher_names_email_addr.email_addr IS 'Email address';
COMMENT ON COLUMN public.wos_publisher_names_email_addr.lang_id IS 'Language of email address';

REVOKE ALL ON TABLE public.wos_publisher_names_email_addr FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_publisher_names_email_addr FROM postgres;
GRANT ALL ON TABLE public.wos_publisher_names_email_addr TO postgres;

CREATE TABLE public.wos_publisher_email_addr (
        id character varying NOT NULL,
        publisher_id integer NOT NULL,
        email_id integer NOT NULL,
        email_addr character varying,
...
COMMENT ON TABLE public.wos_publisher_email_addr IS 'Email Address Data from Publisher Addresses';
COMMENT ON COLUMN public.wos_publisher_email_addr.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_publisher_email_addr.publisher_id IS 'Sequence number of associated publisher';
COMMENT ON COLUMN public.wos_publisher_email_addr.email_id IS 'Email address ID';
COMMENT ON COLUMN public.wos_publisher_email_addr.email_addr IS 'Email address';
COMMENT ON COLUMN public.wos_publisher_email_addr.lang_id IS 'Language of email address';

REVOKE ALL ON TABLE public.wos_publisher_email_addr FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_publisher_email_addr FROM postgres;
GRANT ALL ON TABLE public.wos_publisher_email_addr TO postgres;

CREATE TABLE public.wos_publisher_zip (
        id character varying NOT NULL,
        publisher_id integer NOT NULL,
...
COMMENT ON TABLE public.wos_publisher_zip IS 'Zip Code Data from Publishers';
COMMENT ON COLUMN public.wos_publisher_zip.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_publisher_zip.publisher_id IS 'Sequence number of associated publisher';
COMMENT ON COLUMN public.wos_publisher_zip.zip IS 'Zip code or postal code';
COMMENT ON COLUMN public.wos_publisher_zip.lang_id IS 'Language of zip code data';
COMMENT ON COLUMN public.wos_publisher_zip.location IS 'Undocumented';

REVOKE ALL ON TABLE public.wos_publisher_zip FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_publisher_zip FROM postgres;
GRANT ALL ON TABLE public.wos_publisher_zip TO postgres;

CREATE TABLE public.wos_publisher_organizations (
        id character varying NOT NULL,
        publisher_id integer NOT NULL,
...
COMMENT ON TABLE public.wos_publisher_organizations IS 'Organizations Data from Publishers';
COMMENT ON COLUMN public.wos_publisher_organizations.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_publisher_organizations.publisher_id IS 'Sequence number of associated publisher';
COMMENT ON COLUMN public.wos_publisher_organizations.organization IS 'Organization';
COMMENT ON COLUMN public.wos_publisher_organizations.lang_id IS 'Language of organization data';

REVOKE ALL ON TABLE public.wos_publisher_organizations FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_publisher_organizations FROM postgres;
GRANT ALL ON TABLE public.wos_publisher_organizations TO postgres;

CREATE TABLE public.wos_publisher_suborganizations (
        id character varying NOT NULL,
        publisher_id integer NOT NULL,
...
COMMENT ON TABLE public.wos_publisher_suborganizations IS 'Suborganizations Data from Publishers';
COMMENT ON COLUMN public.wos_publisher_suborganizations.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_publisher_suborganizations.publisher_id IS 'Sequence number of associated publisher';
COMMENT ON COLUMN public.wos_publisher_suborganizations.suborganization IS 'Suborganization';
COMMENT ON COLUMN public.wos_publisher_suborganizations.lang_id IS 'Language of suborganization data';

REVOKE ALL ON TABLE public.wos_publisher_suborganizations FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_publisher_suborganizations FROM postgres;
GRANT ALL ON TABLE public.wos_publisher_suborganizations TO postgres;

CREATE TABLE public.wos_publisher_dois (
        id character varying NOT NULL,
        publisher_id integer NOT NULL,
...
COMMENT ON TABLE public.wos_publisher_dois IS 'DOI Data from Publisher URLs';
COMMENT ON COLUMN public.wos_publisher_dois.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_publisher_dois.publisher_id IS 'Sequence number of associated publisher';
COMMENT ON COLUMN public.wos_publisher_dois.doi IS 'DOI';

REVOKE ALL ON TABLE public.wos_publisher_dois FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_publisher_dois FROM postgres;
GRANT ALL ON TABLE public.wos_publisher_dois TO postgres;
...
CREATE TABLE public.wos_address_email_addr (
        id character varying NOT NULL,
        addr_id integer NOT NULL,
        email_id integer NOT NULL,
        email_addr character varying,
...
COMMENT ON TABLE public.wos_address_email_addr IS 'Email Address Data from Address Names';
COMMENT ON COLUMN public.wos_address_email_addr.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_address_email_addr.addr_id IS 'Sequence number of associated address';
COMMENT ON COLUMN public.wos_address_email_addr.email_addr IS 'Email address';
COMMENT ON COLUMN public.wos_address_email_addr.lang_id IS 'Language of email address';

REVOKE ALL ON TABLE public.wos_address_email_addr FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_address_email_addr FROM postgres;
GRANT ALL ON TABLE public.wos_address_email_addr TO postgres;
...
CREATE TABLE public.wos_address_dois (
        id character varying NOT NULL,
        addr_id integer NOT NULL,
        doi_id integer NOT NULL,
        doi character varying
...
COMMENT ON TABLE public.wos_address_dois IS 'DOI Data from Address URLs';
COMMENT ON COLUMN public.wos_address_dois.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_address_dois.addr_id IS 'Sequence number of associated address';
COMMENT ON COLUMN public.wos_address_dois.doi IS 'DOI';

REVOKE ALL ON TABLE public.wos_address_dois FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_address_dois FROM postgres;
GRANT ALL ON TABLE public.wos_address_dois TO postgres;
...
CREATE TABLE public.wos_grant_alt_agencies (
	id character varying NOT NULL,
	grant_id integer NOT NULL,
...
COMMENT ON TABLE public.wos_grant_alt_agencies IS 'Alternate grant agencies';
COMMENT ON COLUMN public.wos_grant_alt_agencies.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_grant_alt_agencies.grant_id IS 'Order of associated grant record (internal primary key)';
COMMENT ON COLUMN public.wos_grant_alt_agencies.alt_agency_id IS 'Order of alternate agency record (internal primary key)';
COMMENT ON COLUMN public.wos_grant_alt_agencies.alt_agency IS 'Alternate grant agency';
COMMENT ON COLUMN public.wos_grant_alt_agencies.alt_agency_language IS 'Lanugage of grant information';
COMMENT ON COLUMN public.wos_grant_alt_agencies.alt_agency_preferred IS 'Preferred agency flag';

REVOKE ALL ON TABLE public.wos_grant_alt_agencies FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_grant_alt_agencies FROM postgres;
GRANT ALL ON TABLE public.wos_grant_alt_agencies TO postgres;
...
CREATE TABLE public.wos_reprint_address_email_addr (
        id character varying NOT NULL,
        addr_id integer NOT NULL,
        email_id integer NOT NULL,
        email_addr character varying,
...
COMMENT ON TABLE public.wos_reprint_address_email_addr IS 'Email Address Data from Reprint Address Names';
COMMENT ON COLUMN public.wos_reprint_address_email_addr.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_reprint_address_email_addr.addr_id IS 'Sequence number of associated address';
COMMENT ON COLUMN public.wos_reprint_address_email_addr.email_addr IS 'Email address';
COMMENT ON COLUMN public.wos_reprint_address_email_addr.lang_id IS 'Language of email address';

REVOKE ALL ON TABLE public.wos_reprint_address_email_addr FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_reprint_address_email_addr FROM postgres;
GRANT ALL ON TABLE public.wos_reprint_address_email_addr TO postgres;
...
CREATE TABLE public.wos_reprint_address_dois (
        id character varying NOT NULL,
        addr_id integer NOT NULL,
        doi_id integer NOT NULL,
        doi character varying
...
COMMENT ON TABLE public.wos_reprint_address_dois IS 'DOI Data from Reprint Address URLs';
COMMENT ON COLUMN public.wos_reprint_address_dois.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_reprint_address_dois.addr_id IS 'Sequence number of associated address';
COMMENT ON COLUMN public.wos_reprint_address_dois.doi IS 'DOI';

REVOKE ALL ON TABLE public.wos_reprint_address_dois FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_reprint_address_dois FROM postgres;
GRANT ALL ON TABLE public.wos_reprint_address_dois TO postgres;
...
CREATE TABLE public.wos_chapters (
        id character varying NOT NULL,
...
COMMENT ON TABLE public.wos_chapters IS 'Chapter List';
COMMENT ON COLUMN public.wos_chapters.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_chapters.chapter_id IS 'Order of chapter record (internal primary key)';
COMMENT ON COLUMN public.wos_chapters.chapter IS 'Chapter';
COMMENT ON COLUMN public.wos_chapters.chapter_uid IS 'UID';

REVOKE ALL ON TABLE public.wos_chapters FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_chapters FROM postgres;
GRANT ALL ON TABLE public.wos_chapters TO postgres;
...
CREATE TABLE public.wos_contributor_email_addr (
        id character varying NOT NULL,
        contrib_id integer NOT NULL,
        email_id integer NOT NULL,
        email_addr character varying,
...
COMMENT ON TABLE public.wos_contributor_email_addr IS 'Email Address Data from Contributor Names';
COMMENT ON COLUMN public.wos_contributor_email_addr.id IS 'Record ID (internal primary key)';
COMMENT ON COLUMN public.wos_contributor_email_addr.contrib_id IS 'Sequence number of associated name in list';
COMMENT ON COLUMN public.wos_contributor_email_addr.email_addr IS 'Email address';
COMMENT ON COLUMN public.wos_contributor_email_addr.lang_id IS 'Language of email address';

REVOKE ALL ON TABLE public.wos_contributor_email_addr FROM PUBLIC;
REVOKE ALL ON TABLE public.wos_contributor_email_addr FROM postgres;
GRANT ALL ON TABLE public.wos_contributor_email_addr TO postgres;
